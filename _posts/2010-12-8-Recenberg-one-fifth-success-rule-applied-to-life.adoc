= Recenberg one-fifth success rule applied to life
:hp-tags: light bulb, migrated
:published_at: 2010-12-8

For those who are not familiar, Rechenberg's 1/5th rule refers to adaptive mutation in evolutionary strategies. It suggests that the ratio of successful mutations to all mutation should be 1/5. It is a rough heuristic for balancing exploration vs. exploitation that worked out pretty well in experiments.

...
Lets put all this togther to interpret what a deep convolutional neural network might be computing: footnote:[This is my own interpretation and might as well be incorrect.]

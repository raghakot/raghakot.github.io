...
I think that in general, constraining as a research direction is largely unexplored. For example, it might be interesting to try and constraint conv filters to be as _distinct_ and _diverse_ and possible.

...
[.text-center]
.Sliding filter over input image to generate an output area (image borrowed from link:http://intellabs.github.io/RiverTrail/tutorial/[river trail documentation])

...
I wanted to compare how _4pass:[_]rotpass:[_]third_, _8pass:[_]rotpass:[_]third_ and baseline model fared if I tried to predict the output on a _rotated_ cifar10 test image.
**WIP**

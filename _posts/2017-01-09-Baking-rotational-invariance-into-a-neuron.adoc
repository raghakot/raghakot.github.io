...
* Even though convergence is slower, 8/4 rotations seem to offer better invariance compared to _baseline_. It would be interesting to see whether all models converge to the same accuracy eventually.
= Baking rotational invariance into a neuron
:hp-tags: deep learning
:published_at: 2017-01-09
